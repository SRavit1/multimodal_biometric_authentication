...
def load_dataset(dataset):
   ...
   if dataset == 'MNIST':
      ...
      trainset = torchvision.datasets.ImageFolder('/mnt/usb/data/imagenet/train',
                                                  transform=transforms.Compose([transforms.RandomResizedCrop(224),
                                                                                transforms.RandomHorizontalFlip(),
                                                                                transforms.ToTensor(),
                                                                                transforms.Normalize(mean, std),]))
      testset = torchvision.datasets.ImageFolder('/mnt/usb/data/imagenet/val',
